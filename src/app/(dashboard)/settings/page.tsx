    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 text-lg">Manage your account settings and API keys</p>
        </div>
        ...
        <Card className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden">
          ...
          <CardContent className="p-8">
            ...
            {/* Create API Key Form */}
            {showCreateForm && (
              <Card className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden mb-8">
