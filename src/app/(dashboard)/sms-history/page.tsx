      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-center space-x-4">
          <Button
            ...
            className="bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 text-white rounded-xl px-6 py-3 font-medium shadow-lg shadow-teal-500/25"
          >
